...
import com.proyecto.homesegurity.entity.enums.EstadoPerito;
...
public class Perito {
    ...
    @Pattern(regexp = "^[A-Za-z0-9._%+-]+@(gmail|hotmail)\\.com$", 
    ...
    // Relación con Asignaciones de Perito
    ...
    public EstadoPerito getEstado() {
        return estado;
    }

    public void setEstado(EstadoPerito estado) {
        this.estado = estado;
    }
}